...
| Distribuição Windows | Pipeline self-contained `win-x64`, runtime registration-free fornecido pelo mantenedor, instalador Inno Setup por usuário, ZIP portátil, manifesto e SHA-256 implementados; a [v1.1.10](https://github.com/Jessielriffel2/UrusLauncher/releases/tag/v1.1.10) é a release pública atual |
...
A [v1.1.10](https://github.com/Jessielriffel2/UrusLauncher/releases/tag/v1.1.10) é a release pública atual e segue esse fluxo de atualização preparada pela 1.1.3.
