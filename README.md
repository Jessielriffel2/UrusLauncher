...
| Distribuição Windows | Pipeline self-contained `win-x64`, runtime registration-free fornecido pelo mantenedor, instalador Inno Setup por usuário, ZIP portátil, manifesto e SHA-256 implementados; a [v1.1.14](https://github.com/Jessielriffel2/UrusLauncher/releases/tag/v1.1.14) está publicada |
...
A [v1.1.14](https://github.com/Jessielriffel2/UrusLauncher/releases/tag/v1.1.14) está publicada, seguindo esse fluxo de atualização preparado pela 1.1.3.
