...
| `docs/decisoes/ADR-009-provisionamento-runtime-legado.md` | Define `runtime\` prioritário, origem fornecida/autorizada pelo distribuidor, validações de empacotamento e o registro da publicação manual autorizada da 1.1.4. |
