...
2. Manter paridade integral entre os três catálogos JSON incorporados ao assembly `LegendLauncher.App`; cada catálogo possui 206 chaves. Arquivos externos não participam do runtime.
