...
- **Status:** aceito tecnicamente; publicação condicionada à licença
- **Data:** 2026-07-16
...
O controle encontrado é software de terceiros, legado e descontinuado. A Adobe informa que redistribuição exige licença vigente. Uma cópia existente e assinada comprova origem técnica, não concede ao Urus direito de publicação.
...
7. Setup/ZIP com esse runtime só podem ser publicados depois que o distribuidor confirmar a autorização aplicável. Enquanto isso, builds com a cópia local são artefatos privados de validação.
...
- O workflow público precisa receber uma fonte licenciada antes de uma nova tag; falhar sem ela é intencional.
