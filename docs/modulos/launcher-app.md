...
- Na coluna de sessão, somente campos e seleção ficam no scroll. O status de compatibilidade, a ação `ENTRAR E JOGAR`/`VOLTAR AO JOGO` e a legenda continuam ancorados na base.
